...
public class MainActivityAbsHR extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    String[] choosenWorkout = {"","GravAb1", "Jump 600", "Jump K30"};
...
private final static String TAG = DeviceServicesActivity.class.getSimpleName();
    ...
    private final BleServicesAdapter.OnServiceItemClickListener demoClickListener = new BleServicesAdapter.OnServiceItemClickListener() {
        ...
        public void onDemoClick(BluetoothGattService service) {
            ...
            demoIntent.setClass(MainActivityAbsHR.this, demoClass);
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // lstTimers = new ArrayList<>();
        ...
        dropdown.setOnItemSelectedListener(MainActivityAbsHR.this);
        ...
        go.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                handler.postDelayed(runnable,0);
                        ...
                        hideSoftKeyboard(MainActivityAbsHR.this, v); // MainActivity is the name of the class and v is the View parameter used in the button listener method onClick.
        ...
        set.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               t.setText("");
                ...
                listCtAdapter = new ArrayAdapter<>(MainActivityAbsHR.this, android.R.layout.simple_list_item_activated_1, lstCtTimers);
...
//start.start();
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        ...
        if(ModuleAbs.selectedWorkout=="GravAb1"){
            settingsDialog.getWindow().requestFeature(Window.FEATURE_NO_TITLE);
            settingsDialog.setContentView(getLayoutInflater().inflate(R.layout.gravab1
                    , null));
            settingsDialog.show();
        }
        ...
        final ArrayAdapter<String> listCtAdapter = new ArrayAdapter<String>(MainActivityAbsHR.this, android.R.layout.simple_list_item_activated_1, lstCtTimers) {
            @Override
