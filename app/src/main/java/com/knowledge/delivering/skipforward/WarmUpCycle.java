...
public class WarmUpCycle extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    String[] choosenWorkout = {"", "Bike 1","Bike 2.1", "Bike 2.2", "Bike 2.3", "Bike 5"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // set.setEnabled(false);
        ...
        dropdown.setOnItemSelectedListener(WarmUpCycle.this);
        ...
        go.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                handler.postDelayed(runnable,0);
                        ...
                        hideSoftKeyboard(WarmUpCycle.this, v); // MainActivity is the name of the class and v is the View parameter used in the button listener method onClick.
        ...
        set.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               t.setText("");
                ...
                listCtAdapter = new ArrayAdapter<>(WarmUpCycle.this, android.R.layout.simple_list_item_activated_1, lstCtTimers);
