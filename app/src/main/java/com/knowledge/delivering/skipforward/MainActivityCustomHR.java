...
public class MainActivityCustomHR extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
...
private final static String TAG = DeviceServicesActivity.class.getSimpleName();
    ...
    private final BleServicesAdapter.OnServiceItemClickListener demoClickListener = new BleServicesAdapter.OnServiceItemClickListener() {
        ...
        public void onDemoClick(BluetoothGattService service) {
            ...
            demoIntent.setClass(MainActivityCustomHR.this, demoClass);
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // set.setEnabled(false);
        ...
        dropdown.setOnItemSelectedListener(MainActivityCustomHR.this);
        ...
        go.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                handler.postDelayed(runnable,0);
                        ...
                        hideSoftKeyboard(MainActivityCustomHR.this, v); // MainActivity is the name of the class and v is the View parameter used in the button listener method onClick.
        ...
        set.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!t.getText().toString().equalsIgnoreCase("")) {
                    ...
                    listCtAdapter = new ArrayAdapter<>(MainActivityCustomHR.this, android.R.layout.simple_list_item_activated_1, lstCtTimers);
...
//start.start();
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        ...
        final ArrayAdapter<String> listCtAdapter = new ArrayAdapter<String>(MainActivityCustomHR.this, android.R.layout.simple_list_item_activated_1, lstCtTimers) {
            @Override
