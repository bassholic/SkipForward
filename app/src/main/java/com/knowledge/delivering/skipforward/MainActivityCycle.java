...
public class MainActivityCycle extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    String[] choosenWorkout = {"", "Bike 1","Bike 1.1","Bike 2.1", "Bike 2.2", "Bike 2.3", "Bike 5"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // set.setEnabled(false);
        ...
        dropdown.setOnItemSelectedListener(MainActivityCycle.this);
        ...
        go.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                handler.postDelayed(runnable,0);
                        ...
                        hideSoftKeyboard(MainActivityCycle.this, v); // MainActivity is the name of the class and v is the View parameter used in the button listener method onClick.
        ...
        set.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               t.setText("");
                ...
                listCtAdapter = new ArrayAdapter<>(MainActivityCycle.this, android.R.layout.simple_list_item_activated_1, lstCtTimers);
...
public void addListenerOnMusicBox(){
    ...
    private class ViewHolder {
        ...
        public void startCountDown(final long duration) {
          ...
          /*  mediaPlayer = MediaPlayer.create(this, R.raw.cycling_10);
...
//start.start();
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
       ...
       // mediaPlayer = MediaPlayer.create(this, R.raw.good_job);
        if(ModuleBike.selectedWorkout=="Bike 1"){
        ...
        else if(ModuleBike.selectedWorkout=="Bike 1.1"){
            settingsDialog.getWindow().requestFeature(Window.FEATURE_NO_TITLE);
            settingsDialog.setContentView(getLayoutInflater().inflate(R.layout.bike2
                    , null));
            settingsDialog.show();
        }

        else if(ModuleBike.selectedWorkout=="Bike 2.1") {
            settingsDialog.getWindow().requestFeature(Window.FEATURE_NO_TITLE);
        ...
        else if(ModuleBike.selectedWorkout=="Bike 2.2"){
            settingsDialog.getWindow().requestFeature(Window.FEATURE_NO_TITLE);
        ...
        else if(ModuleBike.selectedWorkout=="Bike 2.3"){
            settingsDialog.getWindow().requestFeature(Window.FEATURE_NO_TITLE);
        ...
        else if(ModuleBike.selectedWorkout=="Bike 5"){
            settingsDialog.getWindow().requestFeature(Window.FEATURE_NO_TITLE);
        ...
        final ArrayAdapter<String> listCtAdapter = new ArrayAdapter<String>(MainActivityCycle.this, android.R.layout.simple_list_item_activated_1, lstCtTimers) {
            @Override
