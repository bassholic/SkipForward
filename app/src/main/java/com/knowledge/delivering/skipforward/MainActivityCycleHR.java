...
public class MainActivityCycleHR extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
...
private final static String TAG = DeviceServicesActivity.class.getSimpleName();
    ...
    private final BleServicesAdapter.OnServiceItemClickListener demoClickListener = new BleServicesAdapter.OnServiceItemClickListener() {
        ...
        public void onDemoClick(BluetoothGattService service) {
            ...
            demoIntent.setClass(MainActivityCycleHR.this, demoClass);
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // lstTimers = new ArrayList<>();
        ...
        dropdown.setOnItemSelectedListener(MainActivityCycleHR.this);
        ...
        go.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                handler.postDelayed(runnable,0);
                        ...
                        hideSoftKeyboard(MainActivityCycleHR.this, v); // MainActivity is the name of the class and v is the View parameter used in the button listener method onClick.
        ...
        set.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               t.setText("");
                ...
                listCtAdapter = new ArrayAdapter<>(MainActivityCycleHR.this, android.R.layout.simple_list_item_activated_1, lstCtTimers);
...
//start.start();
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        ...
        final ArrayAdapter<String> listCtAdapter = new ArrayAdapter<String>(MainActivityCycleHR.this, android.R.layout.simple_list_item_activated_1, lstCtTimers) {
            @Override
