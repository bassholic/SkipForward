    ...
    public  class workouts{
        ...
        public void droppedDown(String entry) {
           ...
           // Dialog settingsDialog = new Dialog(Treadmill.this);
            ...
            if (entry.toString().equalsIgnoreCase("Bike 6")) {
                lstCtTimers.add("5 min     easy     warm up");
                lstTimers.add(5 * 60);
                lstCtTimers.add("3 min     low effort      seated");
                lstTimers.add(3 * 60);
                lstCtTimers.add(".5 min    med effort      seated");
                lstTimers.add(30);
                lstCtTimers.add("15 sec    high effort      seated");
                lstTimers.add(15);
                lstCtTimers.add("90 sec    low effort      seated");
                lstTimers.add(90);
                lstCtTimers.add("2 min     med effort      stand");
                lstTimers.add(2 * 60);
                lstCtTimers.add("1 min     low effort      stand");
                lstTimers.add(1 * 60);
                lstCtTimers.add("15 sec    high effort      seated");
                lstTimers.add(15);
                lstCtTimers.add("15 sec    low effort      seated");
                lstTimers.add(15);
                lstCtTimers.add("15 sec    high effort      seated");
                lstTimers.add(15);
                lstCtTimers.add("15 sec    low effort      seated");
                ...
                lstCtTimers.add("15 sec    high effort      seated");
                lstTimers.add(15);
                lstCtTimers.add("2 min     low effort      seated");
                lstTimers.add(120);
                lstCtTimers.add("2 min     high effort     stand");
                lstTimers.add(120);
                lstCtTimers.add("15 sec    max effort      stand");
                lstTimers.add(15);
                lstCtTimers.add("30 sec    low effort      stand");
                lstTimers.add(30);
                lstCtTimers.add("15 sec    max effort      stand");
                lstTimers.add(15);
                lstCtTimers.add("30 sec    low effort      stand");
                ...
                lstCtTimers.add("30 sec    low effort      stand");
                lstTimers.add(30);
                lstCtTimers.add("1 min     med effort      seated");
                lstTimers.add(1 * 60);
                lstCtTimers.add("30 sec    max effort      seated");
                lstTimers.add(30);
                lstCtTimers.add("30 sec    low effort      seated");
                lstTimers.add(30);
                lstCtTimers.add("30 sec    max effort      seated");
                lstTimers.add(30);
                lstCtTimers.add("30 sec    low effort      seated");
                ...
                lstCtTimers.add("30 sec    low effort      seated");
                lstTimers.add(30);
                lstCtTimers.add("5 min     easy      cooldown");
                lstTimers.add(5 * 60);
            }
