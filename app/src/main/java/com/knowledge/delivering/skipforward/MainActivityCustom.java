...
import static com.knowledge.delivering.skipforward.R.id;
import static com.knowledge.delivering.skipforward.R.layout;
import static com.knowledge.delivering.skipforward.R.string;


public class MainActivityCustom extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    ArrayAdapter savedListCtAdapter;
    ...
    public String saveWO = "Louis";//save
    public String listTime = "list";
    ...
    private final BroadcastReceiver gattUpdateReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (BleService.ACTION_GATT_CONNECTED.equals(action)) {
                isConnected = true;
                updateConnectionState(string.connected);
                //invalidateOptionsMenu();
            } else if (BleService.ACTION_GATT_DISCONNECTED.equals(action)) {
                isConnected = false;
                updateConnectionState(string.disconnected);
                // invalidateOptionsMenu();
                clearUI();
    ...
    private final BleServicesAdapter.OnServiceItemClickListener demoClickListener = new BleServicesAdapter.OnServiceItemClickListener() {
        ...
        public void onDemoClick(BluetoothGattService service) {
            ...
            demoIntent.setClass(MainActivityCustom.this, demoClass);
    ...
    private void clearUI() {
        ...
        heartRateField2.setText(string.no_data);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Button go = (Button) findViewById(id.button);
        final Button set = (Button) findViewById(id.button3);
        final Button save = (Button) findViewById(id.save);

        final Button load = (Button) findViewById(id.load);
       //    go.setEnabled(false);
       // set.setEnabled(false);


        text1 = (TextView) findViewById(id.textView1);
        stopwatch = (TextView)findViewById(id.stopwatch);
        countUp = (TextView)findViewById(id.counter);

        handler = new Handler() ;

        ctItems = (ListView) findViewById(id.ctItems);
        savedItems = (ListView) findViewById(id.savedItems);

        //get the spinner from the xml.
         Spinner dropdown = (Spinner)findViewById(id.spinner1);
        ...
        dropdown.setOnItemSelectedListener(MainActivityCustom.this);
        ...
        go.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                handler.postDelayed(runnable,0);
                        ...
                        hideSoftKeyboard(MainActivityCustom.this, v); // MainActivity is the name of the class and v is the View parameter used in the button listener method onClick.
        ...
        set.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               // go.setEnabled(true);
                ...
                EditText t = (EditText) findViewById(id.editText);
                EditText d = (EditText) findViewById(id.description);
                if (!t.getText().toString().equalsIgnoreCase("")) {
                    ...
                    String CDTimer = minutes1 + " mins " + seconds1 + " sec         " + d1;
               ...
               d.setText("");
                ...
                listCtAdapter = new ArrayAdapter<>(MainActivityCustom.this, android.R.layout.simple_list_item_activated_1, lstCtTimers);
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                EditText s = (EditText) findViewById(id.saveAs);
                saveWO = s.getText().toString();
                saveArrayList((ArrayList<String>) lstCtTimers, saveWO);
                saveArrayListInt((ArrayList<Integer>) lstTimers, listTime);
            }
        });
        ...
        load.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                listCtAdapter = new ArrayAdapter<>(MainActivityCustom.this, android.R.layout.simple_list_item_activated_1, getArrayList(saveWO));
                ctItems.setAdapter(listCtAdapter);

                SharedPreferences preferences = getSharedPreferences( getPackageName() + "_preferences", MODE_PRIVATE);
                savedListCtAdapter = new ArrayAdapter<>(MainActivityCustom.this, android.R.layout.simple_list_item_activated_1, getArrayList(saveWO));


                savedItems.setAdapter(savedListCtAdapter);

                int a=0;
                int b=0;
                List<String> tempGSON;
                tempGSON = getArrayList(listTime);
                while( b< tempGSON.size()) {
                        a = Integer.valueOf(tempGSON.get(b).toString());
                    lstTimers.add(a);
                    b++;
                }
            }
    ...
    public void saveArrayListInt(ArrayList<Integer> list, String key){
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(this);
        SharedPreferences.Editor editor = prefs.edit();
        Gson gson = new Gson();
        String json = gson.toJson(list);
...
public void addListenerOnMusicBox(){
        musicBox = (CheckBox) findViewById(id.checkBox);
...
//start.start();
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        ...
        if(parent.getItemAtPosition(position).toString().equalsIgnoreCase("Easy 1")) {
            ...
            settingsDialog.setContentView(getLayoutInflater().inflate(layout.hiit_pop
                    , null));
            settingsDialog.show();
            lstCtTimers.clear();
            lstTimers.clear();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        if (isConnected) {
            menu.findItem(id.menu_connect).setVisible(false);
            menu.findItem(id.menu_disconnect).setVisible(true);
        } else {
            menu.findItem(id.menu_connect).setVisible(true);
            menu.findItem(id.menu_disconnect).setVisible(false);
        }
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch(item.getItemId()) {
            case id.menu_connect:
                bleService.connect(deviceAddress);
                return true;
            case id.menu_disconnect:
