...
public class MainActivityBattle extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
...
private final static String TAG = DeviceServicesActivity.class.getSimpleName();
    ...
    private final BleServicesAdapter.OnServiceItemClickListener demoClickListener = new BleServicesAdapter.OnServiceItemClickListener() {
        ...
        public void onDemoClick(BluetoothGattService service) {
            ...
            demoIntent.setClass(MainActivityBattle.this, demoClass);
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // lstTimers = new ArrayList<>();
        ...
        dropdown.setOnItemSelectedListener(MainActivityBattle.this);
        ...
        go.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                handler.postDelayed(runnable,0);
                        ...
                        hideSoftKeyboard(MainActivityBattle.this, v); // MainActivity is the name of the class and v is the View parameter used in the button listener method onClick.
        ...
        set.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               t.setText("");
                ...
                listCtAdapter = new ArrayAdapter<>(MainActivityBattle.this, android.R.layout.simple_list_item_activated_1, lstCtTimers);
...
//start.start();
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        ...
        if(ModuleJump.selectedWorkout=="Intense 1"){
        ...
        final ArrayAdapter<String> listCtAdapter = new ArrayAdapter<String>(MainActivityBattle.this, android.R.layout.simple_list_item_activated_1, lstCtTimers) {
            @Override
