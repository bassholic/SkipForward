...
import com.knowledge.delivering.skipforward.adapters.BleServicesAdapter.OnServiceItemClickListener;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        demoButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent nextScreen = new Intent(getApplicationContext(), HomepageActivity.class);
